...
class ContractFieldConfig
{
    ...
    private array $optionalFields = [
        'CHARTER' => [
            'charterId', 'areaOrRoute', 'startDay', 'startYear', 'endDay', 'endYear',
            'purpose', 'manifestSummary', 'paymentTerms', 'deposit', 'extras',
            'damageTerms', 'cancellationTerms',
        ],
        'SUBSIDY' => [
            'subsidyId', 'programRef', 'origin', 'destination', 'startDay', 'startYear',
        ...
        'PRIZE' => [
            'prizeId', 'caseRef', 'seizureLocation', 'seizureDay', 'seizureYear',
            'legalBasis', 'jurisdiction', 'prizeDescription', 'estimatedValue',
            'disposition', 'prizeAward', 'paymentTerms', 'shareSplit',
            'awardTrigger', 'notes',
        ],
        'FREIGHT' => [
            'contractId', 'origin', 'destination', 'pickupDay', 'pickupYear',
            'deliveryDay', 'deliveryYear', 'cargoDescription', 'cargoQty',
            'declaredValue', 'paymentTerms', 'liabilityLimit', 'cancellationTerms',
        ],
        'SERVICES' => [
            'serviceId', 'location', 'vesselId', 'serviceType', 'requestedBy',
            'startDay', 'startYear', 'endDay', 'endYear', 'workSummary',
            'partsMaterials', 'risks', 'paymentTerms', 'extras', 'total',
            'liabilityLimit', 'cancellationTerms',
        ],
        'PASSENGERS' => [
            'ticketId', 'origin', 'destination', 'departureDay', 'departureYear',
            'arrivalDay', 'arrivalYear', 'classOrBerth', 'qty', 'passengerNames',
            'passengerContact', 'baggageAllowance', 'extraBaggage', 'fareTotal',
            'paymentTerms', 'refundChangePolicy',
        ],
        'CONTRACT' => [
            'contractId', 'jobType', 'objective', 'location', 'successCondition',
            'startDay', 'startYear', 'deadlineDay', 'deadlineYear', 'payAmount',
        ...
        'INSURANCE' => [
            ...
            'payoutAmount', 'deductible', 'paymentTerms', 'acceptanceEffect',
            'subrogationTerms', 'coverageNotes',
        ],
        'SALVAGE' => [
            'claimId', 'caseRef', 'source', 'siteLocation', 'startDay', 'startYear',
            'endDay', 'endYear', 'recoveredItemsSummary', 'qtyValue', 'hazards',
            'salvageAward', 'paymentTerms', 'splitTerms', 'rightsBasis',
            'awardTrigger', 'disputeProcess',
        ],
        'TRADE' => [
            'dealId', 'location', 'transferPoint', 'transferCondition',
            'goodsDescription', 'qty', 'grade', 'batchIds', 'unitPrice', 'totalPrice',
