...
use App\Service\IncomePlaceholderService;
...
final class IncomeController extends BaseController
{
    ...
    public function __construct(
        ...
        private readonly IncomePlaceholderService $incomePlaceholderService,
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if (!$payerCompany) {
                ...
                if ($alias && $role) {
                    ...
                    $company = $this->companyManager->findOrCreateAuto($alias, $user, $role);
