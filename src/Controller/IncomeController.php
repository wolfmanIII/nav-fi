    ...
    public function new(Request $request, EntityManagerInterface $em): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if (!$payerCompany) {
                ...
                if ($alias && $role) {
                    // Controlla se esiste già una company con questo nome per l'utente (case-insensitive)?
                    // Per ora creiamo direttamente come richiesto dalla logica "Hybrid".
                    // Potremmo usare FinancialAccountManager::resolveBank ma qui è generico.
