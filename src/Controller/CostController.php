...
final class CostController extends BaseController
{
    ...
    public function __construct(
        private readonly FinancialAccountManager $accountManager,
    ...
    public function new(Request $request, EntityManagerInterface $em): Response
    {
        ...
        if ($faId) {
            $fa = $em->getRepository(FinancialAccount::class)->find($faId);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if (!$vendorCompany) {
                ...
                if ($vendorName && $vendorRole) {
                    ...
                    $company = $this->companyManager->findOrCreateAuto($vendorName, $user, $vendorRole);
    ...
    public function delete(
        ...
        $sale = $em->getRepository(Income::class)->findOneBy(['purchaseCost' => $cost]);
        if ($sale) {
