...
class BaseDetailsType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('bridge', GenericComponentType::class, ['label' => 'Command Center'])
            ->add('computer', GenericComponentType::class, ['label' => 'Main Computer'])
            ->add('sensors', GenericComponentType::class, ['label' => 'Sensors'])
            ->add('cargo', GenericComponentType::class, ['label' => 'Storage & Logistics'])
